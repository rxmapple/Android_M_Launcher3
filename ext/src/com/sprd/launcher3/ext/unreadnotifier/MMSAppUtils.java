...
public class MMSAppUtils {
    ...
    private static Collection<SmsApplicationData> getApplicationCollectionInternal(
        ...
        Intent smsIntent = new Intent(Telephony.Sms.Intents.SMS_DELIVER_ACTION);
        ...
        List<ResolveInfo> allResolveInfoList = packageManager.queryIntentActivities(intent, PackageManager.MATCH_DEFAULT_ONLY);
