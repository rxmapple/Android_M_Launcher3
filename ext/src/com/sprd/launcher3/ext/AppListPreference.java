...
public class AppListPreference extends ListPreference {
    ...
    public boolean isPreferenceChecked(){
        return PreferenceManager.getDefaultSharedPreferences(getContext()).getBoolean(getKey()+CHECKBOX_KEY, getContext().getResources().getBoolean(R.bool.config_default_unread_enable));
    }
